...
?>
	...
	<input type="text" name="title" id="listing_title" value="<?php echo form_prep(set_value('title', $content['existing_data']->title)); ?>" />	
	<label>Phone (ie. 555-555-5555):</label>
	<?php echo $this->validation->phone_error; ?>
	<input type="text" name="phone" id="listing_phone" value="<?php echo form_prep(set_value('phone', $content['existing_data']->phone)); ?>" />
	<label>Email:</label>
	<?php echo $this->validation->email_error; ?>
	<input type="text" name="email" id="listing_email" value="<?php echo form_prep(set_value('email', $content['existing_data']->email)); ?>" />
	<label>Website:</label>
	<?php echo $this->validation->url_error; ?>
	<input type="text" name="url" id="listing_url" value="<?php echo form_prep(set_value('url', $content['existing_data']->listing_url)); ?>" />
	<label>Address:</label>
	...
	<textarea name="description" id="listing_description"><?php echo form_prep(set_value('description', $content['existing_data']->listing_description));?></textarea>
