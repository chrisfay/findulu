...
$config['ulu_listing_status_type_table']     = 'listing_status_types';                //stores the types of listings that can be created
...
$config['ulu_default_listing_ad_image']      = 'defaultListingAd.jpg';
$config['ulu_default_listing_coupon_image']  = 'defaultListingCoupon.jpg';
...
$config['ulu_zip_range']                     = 10;                    //the maximum range in miles to return searches for based on a single zip
